...
export default function OwnerDashboard() {
  ...
  /* Try to center the picker map on user's location */
  useEffect(() => {
      ...
      <div className="pt-24 px-6 max-w-2xl mx-auto">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <h2 className="font-headline text-3xl font-black text-on-surface mt-1">
              Mis Restaurantes
            </h2>
          </div>
          <button
        ...
        {success && (
          <div className="bg-tertiary-container/30 border border-tertiary/20 rounded-xl p-3 flex items-center gap-2 mb-4">
            ...
            <p className="text-tertiary font-label font-bold text-sm">
              {success}
            </p>
          </div>
        )}
        ...
        {showForm && (
          <form
            ...
            className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/10 shadow-sm mb-8 space-y-4"
          >
            <h3 className="font-headline text-lg font-bold text-on-surface">
              Publicar nuevo restaurante
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                <label className="text-xs font-bold text-on-surface-variant font-label mb-1 block">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    update("cuisine_type", e.target.value as CuisineType)
                  }
                  required
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    update("average_price", Number(e.target.value))
                  }
                  required
                />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                >
                    ...
                    {form.location_lat && form.location_lng && (
                      ...
                      >
                        <div className="flex flex-col items-center animate-bounce">
                          <div className="w-10 h-10 rounded-full bg-primary shadow-lg flex items-center justify-center text-lg border-2 border-white">
                            📍
                          </div>
                          <div
                  ...
                  {/* Coordinate readout */}
                  <div className="absolute bottom-2 left-2 bg-surface-bright/80 backdrop-blur-sm rounded-lg px-3 py-1.5 text-[10px] font-mono text-on-surface-variant shadow">
          ...
          !showForm && (
            <div className="text-center py-16">
              ...
              <p className="text-on-surface-variant text-sm mb-6">
                Publica tu primer restaurante y empieza a recibir visitantes
              </p>
              <button
